...
{
	/**
	* Parsing helper class for String type.
	*/
	class XMLParseHelperString : public XMLParseHelper
	{
	public:
		/**
		...
		*/
		XMLParseHelperString(const XMLParseHelperString&) = delete;

		/**
		* Disallow XMLParseHelperInteger move semantics.
		*/
		XMLParseHelperString(XMLParseHelperString&&) = delete;

		/**
		* Default destructor of XMLParseHelperInteger.
		*/
		virtual ~XMLParseHelperString() = default;
	...
	private:
		const std::string mHandledTag = "String";
	};
}